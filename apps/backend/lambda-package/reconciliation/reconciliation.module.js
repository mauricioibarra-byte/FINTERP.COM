...
exports.ReconciliationModule = ReconciliationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [reconciliation_service_1.ReconciliationService, smart_matcher_service_1.SmartMatcherService],
        controllers: [reconciliation_controller_1.ReconciliationController],
        exports: [smart_matcher_service_1.SmartMatcherService],
    })
