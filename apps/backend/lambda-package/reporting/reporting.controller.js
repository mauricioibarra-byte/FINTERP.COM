...
let ReportingController = class ReportingController {
    ...
    getFastBalanceSheet(period) {
        return this.reportingService.getFastReport((0, shared_utils_1.getTenantId)(), 'BALANCE_SHEET', period || 'CURRENT');
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], ReportingController.prototype, "getIncomeStatement", null);
__decorate([
    (0, common_1.Get)('balance-sheet/fast'),
    __param(0, (0, common_1.Query)('period')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ReportingController.prototype, "getFastBalanceSheet", null);
